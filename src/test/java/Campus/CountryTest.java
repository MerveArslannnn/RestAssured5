...
public class CountryTest {
  ...
  public void createCountryNegative(){
      ...
      country.put("code",faker.address().countryCode()+faker.number().digits(5));
              ...
              given()
                      .spec(recSpec)
                      .body(country)//giden body i göster
                      .log().body() //giden body i log olarak göster
  ...
  public void updateCountry(){
      ...
      countryName="Merve Arslann"+faker.number().digits(6);
      country.put("name",countryName);
      country.put("code",faker.address().countryCode()+faker.number().digits(5));
      ...
      given()
              ...
              .log().body() //gelen body i log olarak göster
              .statusCode(200)
              .body("name",equalTo(countryName)) //gelen body deki...
      ;
...
//  }
    ...
    //school-service/api/nationality
